...
def scraping(url):
    ...
    if title == "Πρόεδρος Τμήματος" and title2 == "Κοσμήτορας":
        ...
        # professors
        professor_info(soup.findAll("div", class_="range offset-top-15")[2])
        print("-----------------------------------------------------------------")

        # deputy professors
        professor_info(soup.findAll("div", class_="range offset-top-15")[3])
        print("-----------------------------------------------------------------")

        # assistant professors
        professor_info(soup.findAll("div", class_="range offset-top-15")[4])
    else:
        # dean
        ...
        # professors
        professor_info(soup.findAll("div", class_="range offset-top-15")[1])
        print("-----------------------------------------------------------------")
...
def professor_info(temp):
    ...
    for name in temp.findAll("a"):
        names.append(name.text)  # i take the name
    ...
    while i < data.__len__():
        tels.append(data[i])  # i take the telephone number
        i = i + 4
    ...
    while i < data.__len__():
        ...
        emails.append(data[i])  # i take the email
        i = i + 4

    # printing infjormation
    i = 0
    while i < names.__len__():
        print(names[i] + "," + tels[i] + "," + emails[i])
        i = i + 1
